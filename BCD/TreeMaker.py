...
with open('lista.txt', 'r') as file:
    cos=file.read()
    cos2=ast.literal_eval(cos)
#this is the script to take out the list from the file


#### start the script by typing in python: from TreeMaker import *; maketree()
    
def maketree(el=cos2, nl=[]):
    ...
    if len(nl)==0:
        ...
        nodelist=manualnl
    for n in nodelist:
        treelist.append((set([n]), n)) #creation of treelist.
